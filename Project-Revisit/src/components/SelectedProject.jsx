export default function SelectedProject({projectDetail}){

    console.log("control is  in selectedProject" +projectDetail);
    const formattedDate = new Date(projectDetail.dueDate).toLocaleDateString('en-US',
        {
            year : 'numeric',
            month : 'short',
            day : 'numeric'
